 ...
 */
@Deprecated
public class RobotDeprecated extends IterativeRobot 
{
...
//VARIABLES
	...
	public void driveInit(FunctionalityMode setupMode)
	{
		...
		if(setupMode == FunctionalityMode.Encoder || setupMode == FunctionalityMode.Vbus)
		{
			driveConfigEncoder();
    ...
    public void shooterInit(FunctionalityMode setupMode)
    {
    	...
    	if(setupMode == FunctionalityMode.Encoder || setupMode == FunctionalityMode.Encoder)
    	{
    		//1 encoder tick per 20ms
    		ELEVATE_DOWN_SPEED = -1000.0;
    		ELEVATE_UP_SPEED = 1000.0;
