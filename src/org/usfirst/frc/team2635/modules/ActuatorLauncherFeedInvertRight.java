...
public class ActuatorLauncherFeedInvertRight extends BaseActuator<Double>
{
	SpeedController leftShooter;
	SpeedController rightShooter;
	SpeedController feed;
	public ActuatorLauncherFeedInvertRight(SpeedController leftShooter, SpeedController rightShooter, SpeedController feed)
	{
		super();
